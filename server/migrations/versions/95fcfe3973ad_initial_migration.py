...
Revision ID: 95fcfe3973ad
Revises: 7d0a76f7c159
Create Date: 2024-07-29 17:44:32.107801
...
revision = '95fcfe3973ad'
down_revision = '7d0a76f7c159'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.CheckConstraint('length(text) >= 3'),
